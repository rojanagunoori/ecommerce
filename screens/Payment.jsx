...
try {
    ...
    if(init.error) return Toast.show({type:"error",text1:init.error.message});
  ...
  return (
   loaderLoading?<Loader/>:(
    ...
    <View style={styles.container}>
        <RadioButton.Group
        onValueChange={setPaymentMethod} value={paymentMethod}
        >
...
const styles=StyleSheet.create({
    ...
    radioStyleText:{
        fontWeight:"600",fontSize:18,textTransform:"uppercase",color:colors.color2,
        
    },
    btn:{
        backgroundColor:colors.color3,
        borderRadius:100,margin:10,padding:5,
