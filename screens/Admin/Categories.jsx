...
import { defaultStyle,formHeading,inputOptions,colors } from '../../styles/styles'
  ...
  return (
    <View style={{...defaultStyle,backgroundColor:colors.color5}} >
        ...
        <ScrollView style={{
            ...
            <View style={{
                backgroundColor:colors.color2,padding:20,minHeight:400
            }}>
        ...
        <TextInput {...inputOptions} placeholder='Category'  value={category} 
...
<Button textColor={colors.color2} style={{
    ...
    margin:20,
    padding:6
}} loading={loading} disabled={!category} onPress={submitHandler}>Add</Button>
