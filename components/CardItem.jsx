...
const CardItem = ({
    name,amount,qty,stock,index,imgSrc,id,incrementHandler,decrementHandler,navigate
}) => {
...
const styles=StyleSheet.create({
    qtyText:{
        ...
        height:25,width:25,textAlignVertical:"center",textAlign:"center",borderWidth:1,borderRadius:5,
